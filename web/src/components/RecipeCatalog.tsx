...
export const RECIPES: (RecipeConfig & { description: string; risk: string; apy: string; defaultIntervalHours: number })[] = [
  ...
  },
  {
    ...
    description: 'Automated periodic DCA accumulation. Configure total budget, per-execution amount, and execution mode before activation.',
    ...
    routeSteps: ['Configure total DCA budget and per-execution amount', 'Choose execution mode (Prefund or Pull-per-run)', 'Swap USDC to EURC via Arc App Kit Swap', 'Transfer acquired EURC to user vault'],
