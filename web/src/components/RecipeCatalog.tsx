...
export const RECIPES: (RecipeConfig & { description: string; risk: string; apy: string; defaultIntervalHours: number })[] = [
  ...
  },
  {
    ...
    name: 'USDC -> cirBTC Recurring DCA',
    description: 'Automated periodic DCA accumulation. Periodically swaps fixed USDC to cirBTC via Arc App Kit Swap route with configurable slippage cap.',
    ...
    routeSteps: ['Pull fixed USDC allocation', 'Swap USDC to cirBTC via Arc App Kit Swap', 'Transfer acquired cirBTC to user vault'],
